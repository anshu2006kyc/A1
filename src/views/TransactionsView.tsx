          ...
          <button
            ...
            className={`px-3.5 py-1.5 rounded-full text-xs font-bold transition-all cursor-pointer flex items-center space-x-1 shrink-0 ${
              transactionFilter === 'all'
                ? 'btn-chamkila text-white shadow-sm'
          ...
          >
            ...
            <div className="pt-2 border-t border-gray-100 flex items-center justify-between">
              ...
              <button
                ...
                className="btn-chamkila text-white font-bold px-3 py-1.5 rounded-xl text-xs flex items-center space-x-1 cursor-pointer active:scale-95 shadow-sm"
              >
